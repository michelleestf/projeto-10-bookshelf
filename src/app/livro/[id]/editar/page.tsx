...
export default function EditarLivroPage() {
  ...
  // Carregar dados do livro e guardar estado inicial para comparação
  ...
  // Verifica se houve alteração em relação ao estado inicial
  const isChanged = (() => {
  ...
  function handleUpdateBook(e: React.FormEvent) {
    e.preventDefault();
    if (!isValid) {
  ...
  // StarRating igual ao de adicionar
  const StarRating = ({
    value,
    onChange,
  }: {
